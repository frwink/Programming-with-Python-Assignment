...
class CsvReader:
    def read_data(self, filepath):
        """
        This method is responsible for reading a csv file that is composed by a number k of column containing floating point data
        """
        counter = 0
...
class CsvToSql(SqlDumper):
    ...
    def save_csv_to_sqlite(self, table_name, filepath):
        """
        Writes a csv file (at filepath) to a sqllite table named table_name.
        """
        with open(filepath, 'r') as file:
